...
class TestRegistration():
  ...
  def test_registration(self):
    ...
    self.driver.find_element(By.ID, "id_registration-email").send_keys("dimatest@test.ru")
    self.driver.find_element(By.ID, "id_registration-password1").click()
    self.driver.find_element(By.ID, "id_registration-password1").send_keys("dimatest123")
    self.driver.find_element(By.ID, "id_registration-password2").send_keys("dimatest123")
    self.driver.find_element(By.NAME, "registration_submit").click()
    # этот ассерт добавила вручную
    assert self.driver.find_element(By.CSS_SELECTOR, ".alertinner").text == "Thanks for registering!"
    # не может найти элемент по тексту Account
    self.driver.find_element(By.LINK_TEXT, "Account").click()
    self.driver.find_element(By.ID, "delete_profile").click()
    self.driver.find_element(By.ID, "id_password").click()
    self.driver.find_element(By.ID, "id_password").send_keys("dimatest123")
